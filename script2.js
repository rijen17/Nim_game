var aiMode = true;         // whether computer mode is enabled
...
var runWinSequence = function () {
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      ...
      if (player === 1) {
        $('.heap-two').append("<h3 class='win-msg'>Winner!</h3>");
      } else {
